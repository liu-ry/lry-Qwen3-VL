...
echo "=========================================="
echo "多 GPU 训练（DDP，无 DeepSpeed）"
echo "（优化版：禁用梯度检查点，使用Gloo后端）"
echo "=========================================="
...
run_name="qwen3vl_ddp_no_ds"
output_dir="./output_ddp_no_ds"

echo "[INFO] 输出: $output_dir"
mkdir -p "$output_dir"

# Training arguments - 不使用 DeepSpeed，使用标准 DDP
args="
...
echo ""
echo "=========================================="
echo "启动多 GPU 训练（DDP，无 DeepSpeed）"
echo "=========================================="
echo ""
...
echo "[INFO] 环境变量已设置：使用 Gloo 后端，NCCL 优化配置"
